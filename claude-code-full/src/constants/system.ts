...
const DEFAULT_PREFIX = `You are HCS Coder v2, a powerful local autonomous coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are HCS Coder v2, a powerful local autonomous coding agent.`
const AGENT_SDK_PREFIX = `You are HCS Coder v2, a powerful local autonomous coding agent.`
